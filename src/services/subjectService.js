...
class SubjectService {
  ...
  loadStoredSubjects() {
    ...
    // No localStorage record found — return empty array.
    // Real subjects will be populated by useSubjects hook from backend API.
    return [];
  }
  ...
  getSelectedSubjects(learnerType = null) {
    ...
    if (learnerType) {
      ...
      if (matched.length > 0) {
        ...
        // No subjects enrolled for this track yet — return empty (backend will populate via API)
        return [];
      }
    }
