// universalSubjects removed — curriculum subjects are loaded from backend via subjectApi
...
class CurriculumService {
  ...
  getCurriculumSubjects({ learnerType = 'school', options = {}, category = 'All', search = '', sortBy = 'Priority', onlyFavorites = false, customCurriculumId = null, userProgress = null }) {
    ...
    // Real enrolled subjects come from backend via useSubjects hook.
    // Only user-created custom curriculums are merged here.
    let result = [];
