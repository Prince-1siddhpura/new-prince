...
export const ForgotPasswordPage = () => {
  ...
  const requestCode = async (event) => {
    ...
    try {
      ...
      setRequested(true);
      setStatus(response.data?.message || response.message || 'Verification code sent to your email.');
    } catch (err) {
  ...
  const resetPassword = async (event) => {
    ...
    try {
      ...
      setStatus(response.data?.message || response.message || 'Password updated successfully!');
