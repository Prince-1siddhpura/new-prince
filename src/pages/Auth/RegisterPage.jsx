...
export const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/verify-otp?email=${encodeURIComponent(finalEmail)}`, {
        state: {
          email: finalEmail,
          message: '✓ Registration successful! Enter the 6-digit confirmation code dispatched via SMTP to activate your account.'
        }
      });
    } catch (err) {
      console.error(err);
